...
export const adminTestTelegram = () => API.post('/settings/admin/telegram-test');
export const adminGetTelegramStatus = () => API.get('/settings/admin/telegram-status');
...
export const adminSyncServices = (provider_id) =>
  API.post('/services/admin/sync', { provider_id }, { timeout: 300000 });

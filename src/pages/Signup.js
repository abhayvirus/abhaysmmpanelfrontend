...
const styles = {
  ...
  subtitle: { color: '#8ca0b8', fontSize: 14, textAlign: 'center' },
  ...
  btn: { width: '100%', padding: '15px', borderRadius: 10, border: 'none', background: 'linear-gradient(135deg, #6c63ff, #9b59b6)', color: '#fff', fontSize: 16, fontWeight: 700, cursor: 'pointer', marginTop: 8, marginBottom: 8 },
